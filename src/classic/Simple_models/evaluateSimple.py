...
def main():
    ...
    print("Starting evaluation of simple models...")
    df = load_dataset()
    ...
    # 5-fold stratified CV for all simple baselines.
    ...
    metrics_name = "simple_model_metrics_other.csv" if isOtherDataset else "simple_model_metrics.csv"
